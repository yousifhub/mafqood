...
if (isset($_POST['child-name']) || isset($_POST['age']) || isset($_POST['gender']) || isset($_POST['health']) || isset($_POST['date']) || isset($_POST['child-city']) || isset($_POST['reporter-name']) || isset($_POST['phone']) || isset($_POST['reporter-city'])) {
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500;600;700;800&display=swap"
        rel="stylesheet" />
    <title>تقرير طفل تم العثور عليه</title>
    <style>
        /* Fix header overlap */
        body {
            padding-top: 70px;
...
<body>
    ...
    <div class="found-text">
        <h1>تقرير طفل تم العثور عليه</h1>
    </div>
    <div class="found-content">
        ...
        <?php endif ?>
        <form action="../app/upload-report-found.php" method="post" enctype="multipart/form-data">
            <div class="person-info">
                <p class="heading">معلومات الطفل الذي تم العثور عليه</p>
            ...
            <div class="place-date">
                <p class="heading">مكان وتاريخ العثور على الطفل</p>
                <div class="date">
            ...
            <div class="founder-info">
                <p class="heading">معلومات من وجد الطفل</p>
                <div class="founder-name box">
                    <label for="founder-name" class="title">الاسم</label>
                    <input type="text" placeholder="الاسم الكامل" id="founder-name" name="reporter-name"
                        value="<?= $_SESSION['report-data']["reporter-name"] ?? "";
                                                        unset($_SESSION["report-data"]["reporter-name"]) ?>" />
                </div>
                <div class="founder-phone box">
                    <label for="founder-phone" class="title">رقم الهاتف</label>
                    <input type="text" maxlength="11" placeholder="رقم الهاتف" id="founder-phone" name="phone"
